...
const {
    ...
    canManageGroupTasks
} = require('../middlewares/group_middleware');
...
router.post('/', verifyToken, canManageGroupTasks, taskController.createTask);
...
router.put('/reorder', verifyToken, canManageGroupTasks, taskController.reorderTasks);
...
router.get('/:id/attachments', verifyToken, canViewTask, attachmentController.getTaskAttachments);
router.post('/:id/attachments', verifyToken, canParticipateInTask, attachmentController.createTaskAttachment);
