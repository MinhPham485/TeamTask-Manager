...
![Grafana Overview](https://github.com/user-attachments/assets/1eb69732-db6c-483d-be4a-3a857b41efd6)
...
- `teamtask_ai_request_errors_total`
	Total failed AI requests (`status_code >= 400`)
...
![Error and Latency Panels](https://github.com/user-attachments/assets/fcbcc606-815f-43d8-9b75-b2052d36b6c4)
